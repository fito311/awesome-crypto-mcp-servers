...
- **[47620 Solana Data](https://github.com/fito311/solana-data-mcp)** - Pay-per-call Solana onchain data for AI agents over x402 (USDC on Solana, Base or Polygon, no signup, no API key): network health, token price/liquidity, wallet balances, transaction lookup, trending DEX pairs, plus an MCP server trust/security check. Remote Streamable HTTP at `https://47620.xyz/mcp`; official MCP Registry `xyz.47620/solana-data`.
- **[47620 Base + Polygon Data](https://github.com/fito311/evm-data-mcp)** - Pay-per-call Base and Polygon onchain data for AI agents over x402 (USDC on Solana, Base or Polygon, no signup, no API key): network health, block lookup, balances, stablecoins, token price/liquidity, transactions, contracts, gas and trending DEX pairs (18 tools). Remote Streamable HTTP at `https://47620.xyz/mcp/evm`; official MCP Registry `xyz.47620/evm-data`.
